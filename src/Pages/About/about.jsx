  ...
  return (
    <div>
      <p>
        ...
        Your Claim(s) to/with the Company.
      </p>
      <h2> Goals :</h2>
      <p>
        The goals of the claims department include keeping the insurer's promise
        made in the policy and supporting the insurer's profit goal. People
        purchase property-casualty insurance policies to protect against finan-
        cial losses.
      </p>
      <h2> Importance : </h2>
      <p>
        Claims service is therefore important in ensuring that the insured
        person gets what is rightfully deemed appropriate to restore normalcy.
        In this way, the insured person gets the compensation to what was lost
        or damaged.
      </p>
      <h2> Claim purpose : </h2>
      <p>
